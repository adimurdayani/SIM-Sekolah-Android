package com.example.simsekolah.ui.siswa.adapter
...
class AdapterDetailSiswa(var data: ArrayList<Siswa>, var activity: Activity) :
    RecyclerView.Adapter<AdapterDetailSiswa.HolderData>() {
