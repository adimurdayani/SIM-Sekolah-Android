...
import com.example.simsekolah.ui.guru.adapter.AdapterMapel
...
class GuruActivity : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        ApiConfig.instanceRetrofit.mapel().enqueue(object :
    ...
    private fun setDisplay(arryMapel: ArrayList<Mapel>) {

        val layout = LinearLayoutManager(this)
        layout.orientation = LinearLayoutManager.VERTICAL
        rc_data.adapter = AdapterMapel(arryMapel, this)
