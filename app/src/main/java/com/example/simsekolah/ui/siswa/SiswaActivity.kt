package com.example.simsekolah.ui.siswa
...
import com.example.simsekolah.ui.siswa.adapter.AdapterKelas
...
class SiswaActivity : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        ApiConfig.instanceRetrofit.kelas().enqueue(object :
    ...
    private fun setDisplay(arryKelas: ArrayList<Kelas>) {

        val layout = LinearLayoutManager(this)
        layout.orientation = LinearLayoutManager.VERTICAL
        rc_data.adapter = AdapterKelas(arryKelas, this)
